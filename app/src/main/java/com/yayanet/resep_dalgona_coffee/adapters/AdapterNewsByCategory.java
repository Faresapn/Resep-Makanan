...
public class AdapterNewsByCategory extends RecyclerView.Adapter<AdapterNewsByCategory.ViewHolder> {
    ...
    public AdapterNewsByCategory(Context mContext, List<ItemNewsList> arrayItemNewsList) {
